...
import com.lsy.java.model.FutureTaskWorker;
...
public class CompletableFutureExamples {
    ...
    public static void main(String[] args) throws Exception {
        CompletableFutureExamples.thenApply();
        CompletableFutureExamples.thenAccept();
        CompletableFutureExamples.thenRun();
        CompletableFutureExamples.thenCombine();
        CompletableFutureExamples.runAfterBoth();
        CompletableFutureExamples.applyToEither();
        CompletableFutureExamples.anyOf();
        CompletableFutureExamples.runAfterEither();
        CompletableFutureExamples.doBoth2();
        CompletableFutureExamples.handle1();
        CompletableFutureExamples.handle2();
        CompletableFutureExamples.thenAcceptBoth();
        CompletableFutureExamples.whenComplete();
        example();
        threadSafe();
        threadUnSafe();
        allExample();
        ...
        failAfter();
        method();
        CompletableFutureExamples.orderBy();
    }

    private static void orderBy() throws ExecutionException, InterruptedException {
        ThreadPoolExecutor executorServe = new ThreadPoolExecutor(3, Runtime.getRuntime().availableProcessors() * 3, 5, TimeUnit.MINUTES, new ArrayBlockingQueue<>(1000));
...
//                }
    ...
    public static void getAllResult() {
        ...
        list.add(2000l);
        list.add(3000l);
        FutureTaskWorker<Long, String> futureTaskWorker = new FutureTaskWorker<>(list, (Long e) -> CompletableFutureExamples.getThreadName(e));
    ...
    public static void exceptionHandler() {
        ...
        Stream<CompletableFuture<String>> completableFutureStream = taskList.stream().map(num -> {
            return CompletableFuture.supplyAsync(() -> {
                return CompletableFutureExamples.getDouble(num);
            }, executor).handle(new BiFunction<Integer, Throwable, String>() {
                @Override
    ...
    public static void failAfter() {
        CompletableFuture<Object> oneSecondTimeout = CompletableFutureHandleTimeout.failAfter(Duration.ofSeconds(2)).exceptionally(xxx -> "超时");
        List<Object> collect = Stream.of("1", "2", "3", "4", "5", "6", "7").map(x -> CompletableFuture.anyOf(CompletableFutureExamples.createTaskSupplier(x), oneSecondTimeout)).collect(Collectors.toList()).stream().map(CompletableFuture::join).collect(Collectors.toList());
        System.out.println("-------结束------");
    }

    public static void allOf() throws InterruptedException, ExecutionException, TimeoutException {
        CompletableFuture.allOf(CompletableFuture.supplyAsync(() -> CompletableFutureExamples.getData()).whenComplete((v, err) -> System.out.println(Thread.currentThread() + ":::" + v)).exceptionally(e -> "1错"), CompletableFuture.supplyAsync(() -> CompletableFutureExamples.getData()).whenComplete((v, err) -> System.out.println(Thread.currentThread() + ":::" + v)).exceptionally(e -> "1错"), CompletableFuture.supplyAsync(() -> CompletableFutureExamples.getData()).whenComplete((v, err) -> System.out.println(Thread.currentThread() + ":::" + v)).exceptionally(e -> "1错"))
//                .join();
                .get(3, TimeUnit.MINUTES);

        CompletableFuture[] completableFutures = new CompletableFuture[]{CompletableFutureExamples.createTaskSupplier("1"), CompletableFutureExamples.createTaskSupplier("2"), CompletableFutureExamples.createTaskSupplier("3"), CompletableFutureExamples.createTaskSupplier("4")};
        Object val = CompletableFuture.allOf(completableFutures).join();
    }
    ...
    public static void example2() throws InterruptedException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            }).thenApply(ignore -> Stream.of(1, 2, 3).collect(Collectors.toList()));
            comlist.add(f2);
        }
    ...
    private static CompletableFuture<String> createTaskSupplier(String x) {
        return CompletableFuture.supplyAsync(CompletableFutureExamples.getStringSupplier(x)).exceptionally(xx -> xx.getMessage());
    }
    ...
    private static Supplier<String> getStringSupplier(String text) {
        return () -> {
            ...
            try {
                if ("5".equals(text)) CompletableFutureExamples.setSleepTime(4);       //5号超时了
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
...
//        }).completeExceptionally(new TimeoutException());
        ...
        List<CompletableFuture> futures = Arrays.asList(CompletableFuture.completedFuture("hello"), CompletableFuture.completedFuture(" world!"), CompletableFuture.completedFuture(" hello"), CompletableFuture.completedFuture("java!"));
    ...
    private static void anyOf() throws InterruptedException {
        ...
        CompletableFuture<String> cfQueryFromSina = CompletableFuture.supplyAsync(() -> {
            return CompletableFutureExamples.queryCode("中国石油", "https://finance.sina.com.cn/code/");
        });
        CompletableFuture<String> cfQueryFrom163 = CompletableFuture.supplyAsync(() -> {
            return CompletableFutureExamples.queryCode("中国石油", "https://money.163.com/code/");
        });
        // 用anyOf合并为一个新的CompletableFuture:
        CompletableFuture<Object> cfQuery = CompletableFuture.anyOf(cfQueryFromSina, cfQueryFrom163);
        // 两个CompletableFuture执行异步查询:
        CompletableFuture<Double> cfFetchFromSina = cfQuery.thenApplyAsync((code) -> {
            return CompletableFutureExamples.fetchPrice((String) code, "https://finance.sina.com.cn/price/");
        });
        CompletableFuture<Double> cfFetchFrom163 = cfQuery.thenApplyAsync((code) -> {
            return CompletableFutureExamples.fetchPrice((String) code, "https://money.163.com/price/");
        });
        // 用anyOf合并为一个新的CompletableFuture:
