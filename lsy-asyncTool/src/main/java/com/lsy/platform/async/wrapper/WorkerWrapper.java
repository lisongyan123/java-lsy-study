package com.lsy.platform.async.wrapper;

import com.lsy.platform.async.callback.DefaultCallback;
import com.lsy.platform.async.callback.ICallback;
import com.lsy.platform.async.callback.IWorker;
import com.lsy.platform.async.exception.SkippedException;
import com.lsy.platform.async.executor.timer.SystemClock;
import com.lsy.platform.async.worker.DependWrapper;
import com.lsy.platform.async.worker.ResultState;
import com.lsy.platform.async.worker.WorkResult;
